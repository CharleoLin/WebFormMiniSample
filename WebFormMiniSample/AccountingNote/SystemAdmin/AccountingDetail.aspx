<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountingDetail.aspx.cs" Inherits="AccountingNote.SystemAdimin.AccountingDetail" %>
         ...
         <table>            
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Literal ID="ltMag" runat="server"></asp:Literal>
                </td>     
            </tr>
          </table>        
    </form>
